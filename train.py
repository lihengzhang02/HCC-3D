...
def main():
    ...
    num_trainable_params = sum(p.numel() for p in model.mlp_projector.parameters() if p.requires_grad)
    print(f"    mlp_projector: Number of trainable parameters: {num_trainable_params}")

    num_trainable_params = sum(p.numel() for p in model.resampler.parameters() if p.requires_grad)
    print(f"    resampler: Number of trainable parameters: {num_trainable_params}")
